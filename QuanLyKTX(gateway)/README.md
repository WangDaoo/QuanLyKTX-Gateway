...
│   └── CSDL.sql                    # Schema + seed + stored procedures
├── Frontend/                       # Legacy vanilla JS demo portals
│   └── login.html
├── Frontend-React/                 # React + Vite + TypeScript (đang phát triển)
├── Postman/                        # API Testing
│   ├── QuanLyKTX.postman_collection.json
│   └── QuanLyKTX.postman_environment.json
├── QuanLyKTX-Gateway.sln           # Solution file
...
- **React + Vite + TypeScript** (`Frontend-React/`)
- **HTML/CSS/JavaScript** (Vanilla JS demo portals trong `Frontend/`)
