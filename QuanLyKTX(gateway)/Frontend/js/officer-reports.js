            ...
            if (reportContent) {
                reportContent.innerHTML = `
                    <div class="text-center" style="padding: 2rem;">
                        ...
                        <button class="btn btn-primary" onclick="window.officerReports.loadReport()" style="margin-top: 1rem;">
...
// Global functions
function loadReport() {
    window.officerReports.loadReport();
}

function onReportTypeChange() {
    // Officer chỉ xem báo cáo, không cần xử lý gì đặc biệt
}
...
document.addEventListener('DOMContentLoaded', () => {
    window.officerReports = new OfficerReports();
});
